...
export class App extends Component {
  ...
  fetchImages = async () => {
    ...
    console.log("Loading started");  // Added this line to check loader
    ...
    try {
      ...
      console.log("Loading ended");  // Added this line to check loader
      ...
      console.log("Loading error");  // Add this line to check
